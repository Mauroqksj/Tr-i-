...
Misc = Window:AddTab({
	...
	local TravelDress = Tabs.Main:AddToggle("TravelDress", {
		Title = "Auto Sea 2",
		Description = "Faz As Missões Para Desbloquear o Sea 2 Automaticamente",
		Default = false
	})
	...
	local Zou = Tabs.Main:AddToggle("Zou", {
		Title = "Auto Sea 3",
		Description = "As As Missões Para Liberar o Sea 3 Automaticamente",
		Default = false
	})
	...
	local FarmPhaBinh = Tabs.Main:AddToggle("FarmPhaBinh", {
		Title = "Quebrar Vasos",
		Description = "Quebrar Vasos pra matar o Tyrant",
		Default = false
	})
	...
	local ClosetMons = Tabs.Main:AddToggle("ClosetMons", {
		Title = "Auto Farm Inimigos Próximos",
		Description = "Farm Mobs Perto",
		Default = false
	})
	...
	Toggle = Tabs.Main:AddToggle("Toggle", {
		...
		Description = "Farm Material Selecionado",
		Default = false
	})
	...
	local Q = Tabs.Main:AddToggle("Q", {
		...
		Description = "Farmar Ectoplasma Automatico",
		Default = false
	})
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto Desbloquear Raid Dough",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto Desbloquear Raid Phonix",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto Farm Haki da observaçao",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Auto Haki da observaçao V2",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Bringmob = Tabs.Settings:AddToggle("Bringmob", {
		Title = "Bring Mobs",
		Description = "Junta Os Mobs (Se Bugar Reative)",
		Default = true
	})
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		...
		Description = "Faz a Trial da Draco Automaticamente",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.Relic123 = Value
	...
	Toggle = Tabs.Drago:AddToggle("Toggle", {
		Title = "Auto Treinar Draco v4",
		Description = "Treina a Raça Draco Automaticamente",
		Default = false
	})
	Toggle:OnChanged(function(Value)
		_G.TrainDrago = Value
...
spawn(function()
	...
	Tabs.Server:AddButton({
		Title = "Criar Servidor Privado",
		Description = "Cria Um Servidor Privado e entra nele Automaticamente",
		Callback = function()
			task.spawn(function()
